        ...
        private void signinbtn_Click(object sender, EventArgs e)
        {
            ...
            if (conn.IsConnect())
            {
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@accTyp", 2);
                    ...
                    prompt.Show(this, "Department account created successfully", Bunifu.UI.WinForms.BunifuSnackbar.MessageTypes.Information,
